...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: layout wrapper uses role=group for flexible field composition
    <div
      role="group"
      data-slot="field"
...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    // biome-ignore lint/suspicious/noDoubleEquals: optional length may be undefined before comparing
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: deduped error list is static per render
