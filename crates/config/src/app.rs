...
use crate::{auth::AuthConfig, database::DatabaseConfig, observability::ObservabilityConfig, server::ServerConfig};
...
impl AppConfig {
    pub fn load() -> Result<Self> {
      ...
      let auth = AuthConfig {
        ...
        access_token_minutes: raw
            .get_int("access_token_minutes")
            .unwrap_or(30),   
      };
