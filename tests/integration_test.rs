...
use devboard_db::{
  connect, entities::organization, DbConnectOptions, DatabaseConnection,
};
...
const DEFAULT_TEST_DATABASE_URL: &str =
  "postgres://devboard:devboard@localhost:5433/devboard_test";
...
async fn test_register_and_login() {
  ...
  let payload = app
    .auth_service
    .register(
      email.clone(), "Integration User".into(), "password123".into(),
      org_id
    )
    .await
